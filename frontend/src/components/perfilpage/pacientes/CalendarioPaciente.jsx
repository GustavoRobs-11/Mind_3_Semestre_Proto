...
export default function Calendario() {
    ...
    function renderCalendarioMensal() {
        return (
            <div className="calendar-month-container">
                {diasMesAtual.map(({ data, atual }) => {
                    const status = getStatusDia(data);
                    const isHoje =
    ...
    ${isHoje ? "today" : ""}
    ${!atual ? "disabled" : ""}
    ${status === "pendente" ? "nao-confirmada" : ""}
...
`}
                            onClick={() => {
                                const agenda = agendamentos.find((a) => {
                                    const dataAgenda =
                                        parseDateBR(a.diaAgendado);
                                ...
                                if (agenda) abrirAgenda(agenda, data);
                            }}
                        >
                            {data.getDate()}
                        </div>
