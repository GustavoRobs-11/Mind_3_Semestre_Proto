import "../assets/styles/termos/termos.css"
  ...
  return (
    <main className="termos-page">
        ...
        <section className="termos-content">
          <h2>1 - TERMOS E CONDIÇÕES GERAIS DE USO</h2>
          <p>1.1 - O presente documento tem por objetivo regulamentar a relação entre usuários pacientes que tenham qualquer tipo de interação com a plataforma.</p>
          <p>1.2 - Os psicólogos que atendem pela plataforma Mind, atuam em conformidade com as normas e Código de Ética do Conselho Federal de Psicologia. Em relação ao atendimento online estão em consonância com a resolução n° 11/2018, que regula esta modalidade de atendimento.</p>
          <p>1.3 -  Ao utilizar a Plataforma Mind, os usuários aceitam a se submetem às condições destes Termos e Condições de uso da plataforma, bem como sua Política de Privacidade e Políticas de Devolução, bem como a todos os documentos anexos a estes.</p>
          <p>1.4 - A Mind permite que os usuários utilizem o serviço de busca de Psicólogos cadastrados na plataforma, realizado através de filtros de pesquisa, para que os usuários tenham a possibilidade de acessar as informações prestadas na plataforma sobre os profissionais cadastrados e assim estabelecer contato por meios digitais com estes profissionais com a finalidade de acordar tratamento psicoterapêutico.</p>

          <div className="destaque">
            <h2>2 - COMPROMISSO E OBJETIVOS DA PLATAFORMA MIND</h2>
            <p>2.1 - A Mind tem como objetivo cadastrar psicólogos em sua plataforma, com a finalidade de exibição de suas informações para fins de divulgação de seu trabalho, onde estes serão beneficiados coletivamente, bem como as oportunidades aos clientes em busca de atendimento psicológico de sua escolha. Visamos assim promover uma plataforma no âmbito digital, inserindo como resultado dessa exposição dos serviços oferecidos, o livre arbítrio e de formato autônomo, o estabelecimento de contato entre os usuários, de acordo com os interesses particulares, sem qualquer tipo de influência ou controle por parte da plataforma.</p>
            <p>2.2 - A plataforma Mind se compromete a manter a confidencialidade das informações prestadas pelos Psicólogos, anunciantes e usuários cadastrados na plataforma, de acordo com a Política de Privacidade presente na plataforma.</p>
          </div>
          ...
          <div className="space-text">
            <p>a.   Manter o cadastro na Plataforma Mind atualizado; </p>
          ...
          <p>4.2 - Ao aceitar esses termos de uso, o Psicólogo declara estar ciente da obrigação de ter seu registro ativo no Conselho Regional de Psicologia e ter autorização no e-psi para que possa atender clientes na modalidade online, e que na falta de um destes, responderá individualmente, pelas sanções administrativas e legais junto aos órgãos competentes, sem o envolvimento da Mind.</p>
          <p>4.3 - Ao assinar a plataforma, o Psicólogo concorda em exibir sua imagem e seus dados, assim como as demais informações inseridas na plataforma através do seu cadastramento, permitindo assim que sejam divulgados publicamente através da plataforma Mind, durante o período em que a assinatura estiver vigente.</p>       
          <p>4.4 - O Psicólogo assinante da plataforma, compreende e concorda que, após a cessão do período de assinatura adquirido, seus dados serão removidos da plataforma e da área de exibição dos profissionais</p>        
          <p>4.5 - O Psicólogo poderá, opcionalmente, solicitar a exclusão de seus dados pelo canal de contato disponível e presente na plataforma no momento.</p>
          <p>4.6 - Os Psicólogos, durante o período de vigência da assinatura da plataforma, passam a ter o direito de acessar, corrigir, atualizar ou excluir seus dados pessoais na plataforma, sendo estes de total responsabilidade do Psicólogo, e assim concordando com as ferramentas vigentes e disponíveis no painel de usuário, aplicáveis para tal finalidade, bem como concordam com as opções oferecidas em cada item do menu de atualização cadastral, sobretudo quanto aos valores e tempo de sessão permitidos pelo sistema da plataforma.</p>
          <p>4.7 - O Psicólogo concorda que deve:</p>
          <div className="space-text">
            <p>a.   Manter qualidade ética e técnica satisfatória com seus clientes quanto à prestação de seus serviços;</p>
            <p>b.   Manter-se devidamente regular perante o Conselho Regional de Psicologia da sua região de atuação, assim como sua autorização no E-PSI, que permite ao Psicólogo o exercício do atendimento online;</p>
            <p>c.   Manter cadastro atualizado na Plataforma Mind; </p>
            <p>d.   Garantir a segurança e o sigilo das informações, relatórios e quaisquer outros documentos de seus clientes, por métodos próprios, sejam eles físicos ou tecnológicos, impedindo o acesso, o compartilhamento e o uso indevido desses dados por quaisquer outras pessoas;</p>
            <p>e.   Os Psicólogos concordam em utilizar a plataforma Mind de forma responsável e ética, não compartilhando informações falsas ou enganosas, não utilizando a plataforma para práticas ilícitas ou antiéticas, ou mesmo a denegrindo ou praticando atos caluniosos, e respeitando os direitos autorais e de propriedade intelectual da plataforma.</p>
          </div>
          <p>4.8 - Os horários disponíveis de cada psicólogo são disponibilizados no site para marcação de consultas. É responsabilidade do psicólogo manter seus horários disponíveis atualizados e informar a plataforma Mind em caso de alterações.</p>

          <h2>5 - TERMOS E CONDIÇÕES ESPECIFICAS AOS PSICOLOGOS RECÉM FORMADOS CADASTRADOS COMO VOLUNTARIO</h2>
          <p>5.1 - Estes termos regulam a participação do profissional recém-formado como voluntário na plataforma Mind, sua interação com outros profissionais e com psicólogos experientes que prestarão orientação e supervisão durante o uso da plataforma.</p>
          <p>5.2 - Inscrição e elegibilidade na participação como voluntário na plataforma Mind,  deverá atender aos seguintes requisitos: </p>
          <div className="space-text">
            <p> a.  Ser recém-formado em psicologia, com diploma emitido por instituição de ensino superior reconhecida pelo MEC.</p>
            <p>b.  Possuir registro ativo no Conselho Regional de Psicologia (CRP) ou estar em processo de obtenção do registro.</p>
            <p>c.  Concordar em atuar de forma voluntária, comprometendo-se a seguir as diretrizes de conduta estabelecidas pela Mind e pelo Código de Ética Profissional do Psicólogo</p>
          </div>
